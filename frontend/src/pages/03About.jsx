...
export const About = () => {
  return (<>
    ...
    <section className=" flex  text-center justify-center my-12    sm: px-4 ">
    <div className="flex flex-col items-center justify-center max-w-4xl  p-6 shadow-md rounded-xl sm:px-12   dark:bg-gray-950 dark:text-gray-100">
    <img src={Myimg} alt="" className=" object-cover  w-28 h-28 mx-auto rounded-full p-1 dark:bg-gray-500 aspect-square" />
    <div className="space-y-4 text-center divide-y dark:divide-gray-700">
      <div className="my-2 space-y-1">
        <h2 className="text-xl font-semibold sm:text-2xl">Kuldeep patel</h2>
        {/* <p className="px-5 text-xs sm:text-base dark:text-gray-400">Full-stack developer</p> */}
        <p className="px-5 text-xs sm:text-base dark:text-gray-200">Full-stack developer</p>
        <p>
          i am the developer of this beautiful site... this is my first react project so it's not refine but Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis, saepe impedit! Nobis corrupti aut inventore tempora non earum, dolorum facere odio accusantium deserunt!
        </p>
      </div>
