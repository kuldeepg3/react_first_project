...
export const Login = () => {
  return (<>
    ...
    <div className="container mx-auto mt-4 mb-12 max-w-md p-12 rounded-xl dark:bg-gray-900 dark:text-gray-100">
    ...
    <form noValidate="" action="/" className="space-y-6 ">
      ...
      <button className="block w-full p-2 m-1 text-center rounded-sm dark:text-gray-900 dark:bg-violet-400">Sign in</button>
    </form>
