	...
	<div className=" flex items-center justify-center gap-2 ">
		...
		<div className="flex flex-col justify-center item-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
			...
			<div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
				...
				<Link rel="noopener noreferrer" to="/signup" className="px-8 py-3 text-lg font-semibold border rounded dark:border-gray-100  hover:bg-violet-400  transition-all ease-linear hover:text-gray-950">Sign up</Link>
			</div>
